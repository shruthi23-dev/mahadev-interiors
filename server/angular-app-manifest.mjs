...
export default {
  ...
  assets: {
    ...
    'bedroom/index.html': {size: 20914, hash: 'd0f69c72d4eac397c56c54266b617471c6845c7119bac6b1b64e580ead1e5382', text: () => import('./assets-chunks/bedroom_index_html.mjs').then(m => m.default)},
